	...
	<div class="row">
		<div class="col-md-12">							
			<div class="form-group">						
				...
				<div class="col-md-7">							
					<input type="text" style="margin-bottom: 10px;" name="inventoryHedding" value="<?=isset($product[0]->inventoryHedding)?$product[0]->inventoryHedding:'';?>" class="form-control" data-validate="required" data-message-required="Please Enter Your Mobile Number" placeholder="Inventory Hedding">
				</div>	
			</div>		
		</div>	
	</div>	
	<div class="row">
		<div class="col-md-12">	
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" style="margin-bottom: 10px;" value="<?=isset($product[0]->categoryName)?$product[0]->categoryName:'';?>" name="categoryName" class="form-control" data-validate="required" data-message-required="Please Enter Your Mobile Number" placeholder="Category Name">
				</div>	
			</div>	
		</div>	
	</div>		
	<div class="row">	
		<div class="col-md-12">	
			<div class="form-group">
				...
				<div class="col-md-7">	
					<input type="number" data-validate="required" data-message-required="Please Enter Your Mobile Number" style="margin-bottom: 10px;" value="<?=isset($product[0]->quantity)?$product[0]->quantity:'';?>" name="quantity" class="form-control" placeholder="Quantity">	
				</div>	
			</div>		
		</div>		
	</div>		
