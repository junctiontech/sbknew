					...
					<div class="panel panel-default">							
						...
						<div id="collapseOne-2" class="panel-collapse collapse">							
							<div class="panel-body">								
								...
								<p>Before booking a flight, consider if the rate is cheaper if paid in another currency. An important note when doing this: make sure you’re using a credit card that is free of foreign-transaction fees.</p>
							</div>
							<div class="clear"></div>						
						</div>					
					</div>
